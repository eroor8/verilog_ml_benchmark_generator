...
module SM_LoadBufs__buffer_count_2__write_count_8
(
buf_address,
clk,
rdy,
...
//  localparam wire [3:0] __const__write_count_at_upblk_set_wen  = 4'd8;
//  localparam wire [1:0] __const__buffer_count_at_upblk_set_wen  = 2'd2;
  ...
  // PyMTL Update Block Source
  // At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py:84
  // @update_ff
  // def upblk_set_wen():
  //     if s.reset:
  //         s.buf_count <<= 0
  ...
  always @(posedge clk) begin : upblk_set_wen
    if ( reset ) begin
      ...
      if ( buf_address == ( 4'd8 - 3'd1 ) ) begin
        buf_address <= 3'd0;
...
// Full name: SM_PreloadMLBWeights__addr_width_2__num_outer_tiles_1__outer_tile_size_1__inner_tile_size_1__outer_tile_repeat_x_1__inner_tile_repeat_x_1
// At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py

module SM_PreloadMLBWeights__15b815de6e893165
(
address,
clk,
rdy,
...
//  localparam wire __const__inner_tile_size_at_upblk_preload_comb  = 1'd1;
//  localparam wire __const__outer_tile_size_at_upblk_preload_comb  = 1'd1;
...
//  localparam wire __const__inner_tile_size_at_upblk_preload_ff  = 1'd1;
...
//  localparam wire __const__num_outer_tiles_at_upblk_preload_ff  = 1'd1;
  ...
  always@(*) begin : upblk_preload_comb
    addr_w = ( index_within_inner_tile + ( inner_tile_index * 1'd1 ) ) + ( outer_tile_index * 1'd1 );
    address = addr_w[1'd1:1'd0];
  end
  ...
  always @(posedge clk) begin : upblk_preload_ff
    if ( reset ) begin
      ...
      if ( index_within_inner_tile < ( 1'd1 - 2'd1 ) ) begin
        ...
        if ( inner_tile_repeat_count < ( 1'd1 - 1'd1 ) ) begin
          ...
          inner_tile_repeat_count <= 1'd0;
          if ( inner_tile_index < ( 1'd1 - 2'd1 ) ) begin
            ...
            if ( outer_tile_repeat_count < ( 1'd1 - 1'd1 ) ) begin
              ...
              outer_tile_repeat_count <= 1'd0;
              if ( outer_tile_index < ( 1'd1 - 2'd1 ) ) begin
...
// Full name: SM_IterateThruAddresses__write_count_8__addr_width_3__initial_address_0__skip_n_0__start_wait_0
// At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py

module SM_IterateThruAddresses__cbfcf811edc380c4
(
address,
clk,
incr,
...
// PyMTL Component SM_IterateThruAddresses Definition
// Full name: SM_IterateThruAddresses__write_count_8__addr_width_3__initial_address_-1__skip_n_0__start_wait_0
// At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py

module SM_IterateThruAddresses__45fdc1a061e7c747
(
address,
clk,
incr,
...
// Full name: SM_WriteOffChip__buffer_count_4__write_count_8__addr_width_3__datawidth_32
// At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py

module SM_WriteOffChip__c4609131afa6a1b6
(
address,
clk,
datain_0,
...
//  localparam wire [2:0] __const__buffer_count_at_upblk_set_wen_ff  = 3'd4;
  ...
  // PyMTL Update Block Source
  // At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py:140
  // @update_ff
...
input datapath_mlb_modules_acc_en_top_sm ;
...
//  localparam wire [4:0] __const__LOADING_I_BUFFERS_at_connect_weight_address  = 5'd3;
  ...
  wire datapath_mlb_modules_acc_en_top_sm_tieoff;
  ...
  wire [2:0] load_ibufs__buf_address;
  wire load_ibufs__clk;
  wire load_ibufs__rdy;
  wire load_ibufs__reset;
  wire load_ibufs__start;
  wire load_ibufs__wen_0;
  wire load_ibufs__wen_1;

  SM_LoadBufs__buffer_count_2__write_count_8 load_ibufs
  (
  ...
  wire load_wbufs__clk;
  wire load_wbufs__rdy;
  wire load_wbufs__reset;
  wire load_wbufs__start;
  wire load_wbufs__wen_0;
  wire load_wbufs__wen_1;
  ...
  SM_PreloadMLBWeights__15b815de6e893165 preload_weights
  (
  ...
  SM_IterateThruAddresses__cbfcf811edc380c4 stream_inputs
  (
  ...
  SM_IterateThruAddresses__45fdc1a061e7c747 stream_outputs
  (
  ...
  wire write_off__rdy;
  wire write_off__reset;
  wire write_off__start;
  wire write_off__wen;

  SM_WriteOffChip__c4609131afa6a1b6 write_off
  (
  ...
  // PyMTL Update Block Source
  // At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py:489
  // @update
  ...
  always@(*) begin : connect_weight_address
    ...
    load_wbufs__start = ( state == 5'd1 ) & sm_start;
    load_ibufs__start = ( state == 5'd2 ) & load_wbufs__rdy;
    preload_weights__start = ( state == 5'd3 ) & load_ibufs__rdy;
    stream_inputs__start = ( state == 5'd4 ) & preload_weights__rdy;
    stream_outputs__start = ( state == 5'd4 ) & preload_weights__rdy;
    write_off__start = ( state == 5'd5 ) & stream_outputs__rdy;
  end

  // PyMTL Update Block Source
  // At /home/esther/benchmark_gen/verilog_ml_benchmark_generator/verilog_ml_benchmark_generator/state_machine_classes.py:461
  // @update_ff
